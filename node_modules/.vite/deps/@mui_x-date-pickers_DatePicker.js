import {
  warnOnce
} from "./chunk-GZPAZASR.js";
import {
  LocalizationProvider,
  MuiPickersAdapterContext
} from "./chunk-VNE7O5VA.js";
import {
  ButtonBase_default,
  Button_default,
...
import "./chunk-MEQFGNLZ.js";
import {
  Paper_default
} from "./chunk-PROF4XLD.js";
import "./chunk-PBZSYKBW.js";
import "./chunk-OBO5RRJ2.js";
import {
  styled_default,
  useTheme
...
var useLocalizationContext = () => {
  const localization = React12.useContext(MuiPickersAdapterContext);
  ...
  const localeText = React12.useMemo(() => _extends({}, DEFAULT_LOCALE, localization.localeText), [localization.localeText]);
  return React12.useMemo(() => _extends({}, localization, {
    localeText
...
var PickersToolbar = React13.forwardRef(function PickersToolbar2(inProps, ref) {
...
function useValidation(options) {
  ...
  const previousValidationErrorRef = React16.useRef(validator2.valueManager.defaultErrorState);
...
var PickersPopperPaperWrapper = React17.forwardRef((props, ref) => {
  const {
    PaperComponent,
    popperPlacement,
...
var useOpenState = ({
  ...
  const isControllingOpenProp = React18.useRef(typeof open === "boolean").current;
  const [openState, setIsOpenState] = React18.useState(false);
  React18.useEffect(() => {
  ...
  const setIsOpen = React18.useCallback((newIsOpen) => {
    if (!isControllingOpenProp) {
...
var useValueWithTimezone = ({
  ...
  const utils = useUtils();
  const firstDefaultValue = React19.useRef(defaultValue);
  const inputValue = valueProp ?? firstDefaultValue.current ?? valueManager.emptyValue;
  const inputTimezone = React19.useMemo(() => valueManager.getTimezone(utils, inputValue), [utils, valueManager, inputValue]);
  ...
  const valueWithTimezoneToRender = React19.useMemo(() => valueManager.setTimezone(utils, timezoneToRender, inputValue), [valueManager, utils, timezoneToRender, inputValue]);
...
var usePickerValue = ({
  ...
  const {
    current: defaultValue
  } = React20.useRef(inDefaultValue);
  const {
    current: isControlled
  } = React20.useRef(inValueWithoutRenderTimezone !== void 0);
  if (true) {
    React20.useEffect(() => {
  ...
  const [dateState, setDateState] = React20.useState(() => {
    let initialValue;
  ...
  const viewValue = React20.useMemo(() => valueManager.cleanValue(utils, dateState.draft), [utils, valueManager, dateState.draft]);
  const viewResponse = {
    value: viewValue,
...
function useViews({
  ...
  const previousViews = React21.useRef(views);
  const defaultView = React21.useRef(views.includes(openTo) ? openTo : views[0]);
...
var usePickerViews = ({
  ...
  const timeViewsCount = React22.useMemo(() => views.reduce((acc, viewForReduce) => {
...
var useIsLandscape = (views, customOrientation) => {
  const [orientation, setOrientation] = React23.useState(getOrientation);
  useEnhancedEffect_default(() => {
    const eventHandler = () => {
...
var PickersLayout = React28.forwardRef(function PickersLayout2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersLayout"
  });
  ...
  return (0, import_jsx_runtime7.jsxs)(PickersLayoutRoot, {
    ...
    children: [isLandscape ? shortcuts : toolbar, isLandscape ? toolbar : shortcuts, (0, import_jsx_runtime7.jsx)(PickersLayoutContentWrapper, {
      ...
      children: wrapperVariant === "desktop" ? (0, import_jsx_runtime7.jsxs)(React28.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime7.jsxs)(React28.Fragment, {
...
var PickersContext = React29.createContext(null);
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime10.jsxs)(React31.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime10.jsxs)(React31.Fragment, {
  children: [(0, import_jsx_runtime10.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime10.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var useClearableField = (props) => {
  ...
  return _extends({}, other, {
    InputProps: _extends({}, InputProps, {
      endAdornment: (0, import_jsx_runtime11.jsxs)(React37.Fragment, {
...
true ? PickersSection.propTypes = {
  ...
  element: import_prop_types8.default.shape({
...
var PickersSectionList = React41.forwardRef(function PickersSectionList2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersSectionList"
  });
  ...
  React41.useImperativeHandle(sectionListRef, () => ({
    getRoot() {
  ...
  return (0, import_jsx_runtime12.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime12.jsx)(React41.Fragment, {
...
var PickersInputBase = React42.forwardRef(function PickersInputBase2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInputBase"
  });
...
var PickersOutlinedInput = React44.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersOutlinedInput"
  });
  ...
  return (0, import_jsx_runtime15.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime15.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime15.jsxs)(React44.Fragment, {
        children: [label, " ", "*"]
      }) : label,
      ownerState
    })
...
var PickersTextField = React47.forwardRef(function PickersTextField2(inProps, ref) {
  ...
  return (0, import_jsx_runtime18.jsxs)(PickersTextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    ref: handleRootRef,
    focused,
    onFocus,
    ...
    children: [(0, import_jsx_runtime18.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    ...
    }, InputProps)), helperText && (0, import_jsx_runtime18.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
...
function DayCalendar(inProps) {
  ...
  return (0, import_jsx_runtime23.jsxs)(PickersCalendarDayRoot, {
    role: "grid",
    ...
    children: [(0, import_jsx_runtime23.jsxs)(PickersCalendarDayHeader, {
      ...
      }), getWeekdays(utils, now).map((weekday, i) => (0, import_jsx_runtime23.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
...
var PickersMonth = React55.memo(function PickersMonth2(inProps) {
  ...
  return (0, import_jsx_runtime24.jsx)(PickersMonthRoot, _extends({
    ...
    children: (0, import_jsx_runtime24.jsx)(MonthButton, _extends({}, monthButtonProps))
  }));
});
...
var PickersYear = React57.memo(function PickersYear2(inProps) {
  ...
  return (0, import_jsx_runtime26.jsx)(PickersYearRoot, _extends({
    ...
    children: (0, import_jsx_runtime26.jsx)(YearButton, _extends({}, yearButtonProps))
  }));
});
...
var _excluded30 = ["autoFocus", "className", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "readOnly", "shouldDisableYear", "disableHighlightToday", "onYearFocus", "hasFocus", "onFocusedViewChange", "yearsOrder", "yearsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var PickersArrowSwitcher = React59.forwardRef(function PickersArrowSwitcher2(inProps, ref) {
  ...
  return (0, import_jsx_runtime28.jsxs)(PickersArrowSwitcherRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime28.jsx)(PreviousIconButton, _extends({}, previousIconButtonProps, {
      children: isRtl ? (0, import_jsx_runtime28.jsx)(RightArrowIcon, _extends({}, rightArrowIconProps)) : (0, import_jsx_runtime28.jsx)(LeftArrowIcon, _extends({}, leftArrowIconProps))
    })), children ? (0, import_jsx_runtime28.jsx)(Typography_default, {
      variant: "subtitle1",
      component: "span",
      id: labelId,
      children
    }) : (0, import_jsx_runtime28.jsx)(PickersArrowSwitcherSpacer, {
      className: classes.spacer,
      ownerState
    }), (0, import_jsx_runtime28.jsx)(NextIconButton, _extends({}, nextIconButtonProps, {
      children: isRtl ? (0, import_jsx_runtime28.jsx)(LeftArrowIcon, _extends({}, leftArrowIconProps)) : (0, import_jsx_runtime28.jsx)(RightArrowIcon, _extends({}, rightArrowIconProps))
    }))]
  }));
});
...
var PickersCalendarHeader = React61.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  ...
  return (0, import_jsx_runtime29.jsxs)(PickersCalendarHeaderRoot, _extends({}, other, {
    ownerState,
    className: clsx_default(classes.root, className),
    ref,
    children: [(0, import_jsx_runtime29.jsxs)(PickersCalendarHeaderLabelContainer, {
      ...
      children: [(0, import_jsx_runtime29.jsx)(PickersFadeTransitionGroup, {
        reduceAnimations,
        transKey: label,
        children: (0, import_jsx_runtime29.jsx)(PickersCalendarHeaderLabel, {
          id: labelId,
          ownerState,
          className: classes.label,
          children: label
        })
      }), views.length > 1 && !disabled && (0, import_jsx_runtime29.jsx)(SwitchViewButton, _extends({}, switchViewButtonProps, {
        children: (0, import_jsx_runtime29.jsx)(SwitchViewIcon, _extends({}, switchViewIconProps))
      }))]
    }), (0, import_jsx_runtime29.jsx)(Fade_default, {
      in: view === "day",
      children: (0, import_jsx_runtime29.jsx)(PickersArrowSwitcher, {
        slots,
        slotProps,
...
function useDateCalendarDefaultizedProps(props, name) {
  ...
  return _extends({}, themeProps, {
    ...
    renderLoading: themeProps.renderLoading ?? (() => (0, import_jsx_runtime30.jsx)("span", {
      children: "..."
    })),
    minDate: applyDefaultDate(utils, themeProps.minDate, defaultDates.minDate),
    maxDate: applyDefaultDate(utils, themeProps.maxDate, defaultDates.maxDate)
...
var DateCalendar = React62.forwardRef(function DateCalendar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime30.jsxs)(DateCalendarRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime30.jsx)(CalendarHeader, _extends({}, calendarHeaderProps, {
      slots,
      slotProps
...
var renderDateViewCalendar = ({
  ...
  displayWeekNumber,
  timezone
}) => (0, import_jsx_runtime31.jsx)(DateCalendar, {
  view,
  onViewChange,
...
function PickersModalDialog(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(Dialog, _extends({
    open,
    onClose: onDismiss
    ...
    children: (0, import_jsx_runtime32.jsx)(PickersModalDialogContent, {
      children
    })
  }));
}
...
var useMobilePicker = (_ref) => {
  ...
  const handleFieldRef = useForkRef(fieldRef, fieldProps.unstableFieldRef);
  const renderPicker = () => (0, import_jsx_runtime33.jsxs)(PickersProvider, {
    contextValue,
    localeText,
    children: [(0, import_jsx_runtime33.jsx)(Field, _extends({}, fieldProps, {
      slots: slotsForField,
      slotProps,
      unstableFieldRef: handleFieldRef
    })), (0, import_jsx_runtime33.jsx)(PickersModalDialog, _extends({}, actions, {
      open,
      slots,
      slotProps,
      children: (0, import_jsx_runtime33.jsx)(Layout, _extends({}, layoutProps, slotProps == null ? void 0 : slotProps.layout, {
        slots,
        slotProps,
        children: renderCurrentView()
      }))
...
var DatePicker = React68.forwardRef(function DatePicker2(inProps, ref) {
  ...
  if (isDesktop) {
    return (0, import_jsx_runtime34.jsx)(DesktopDatePicker, _extends({
      ref
    }, other));
  }
  return (0, import_jsx_runtime34.jsx)(MobileDatePicker, _extends({
    ref
  }, other));
});
